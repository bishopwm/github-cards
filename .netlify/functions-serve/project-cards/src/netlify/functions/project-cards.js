...
var require_constants2 = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/lib/constants.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.COOKIE_OPTIONS = exports2.STORAGE_KEY = exports2.NETWORK_FAILURE = exports2.EXPIRY_MARGIN = exports2.DEFAULT_HEADERS = exports2.AUDIENCE = exports2.GOTRUE_URL = void 0;
...
var require_cookies = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/lib/cookies.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.deleteCookie = exports2.setCookie = exports2.setCookies = exports2.getCookieString = void 0;
...
var require_helpers2 = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/lib/helpers.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.removeItemAsync = exports2.getItemSynchronously = exports2.getItemAsync = exports2.setItemAsync = exports2.resolveFetch = exports2.getParameterByName = exports2.isBrowser = exports2.uuid = exports2.expiresAt = void 0;
    ...
    var setItemAsync = (storage, key, data) => __awaiter(void 0, void 0, void 0, function* () {
      (0, exports2.isBrowser)() && (yield storage === null || storage === void 0 ? void 0 : storage.setItem(key, JSON.stringify(data)));
    });
    exports2.setItemAsync = setItemAsync;
    var getItemAsync = (storage, key) => __awaiter(void 0, void 0, void 0, function* () {
      const value = (0, exports2.isBrowser)() && (yield storage === null || storage === void 0 ? void 0 : storage.getItem(key));
      if (!value)
        return null;
      try {
    ...
    var getItemSynchronously = (storage, key) => {
      const value = (0, exports2.isBrowser)() && (storage === null || storage === void 0 ? void 0 : storage.getItem(key));
    ...
    var removeItemAsync = (storage, key) => __awaiter(void 0, void 0, void 0, function* () {
      (0, exports2.isBrowser)() && (yield storage === null || storage === void 0 ? void 0 : storage.removeItem(key));
    });
    ...
    var GoTrueApi = class {
      ...
      signInWithEmail(email, password, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const data = yield (0, fetch_1.post)(this.fetch, `${this.url}/token${queryString}`, { email, password }, { headers: headers2 });
            const session = Object.assign({}, data);
            if (session.expires_in)
              session.expires_at = (0, helpers_1.expiresAt)(data.expires_in);
            return { data: session, error: null };
      ...
      signInWithPhone(phone, password) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const data = yield (0, fetch_1.post)(this.fetch, `${this.url}/token${queryString}`, { phone, password }, { headers: headers2 });
            const session = Object.assign({}, data);
            if (session.expires_in)
              session.expires_at = (0, helpers_1.expiresAt)(data.expires_in);
            return { data: session, error: null };
      ...
      signInWithOpenIDConnect({ id_token, nonce, client_id, issuer, provider }) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const data = yield (0, fetch_1.post)(this.fetch, `${this.url}/token${queryString}`, { id_token, nonce, client_id, issuer, provider }, { headers: headers2 });
            const session = Object.assign({}, data);
            if (session.expires_in)
              session.expires_at = (0, helpers_1.expiresAt)(data.expires_in);
            return { data: session, error: null };
      ...
      verifyMobileOTP(phone, token2, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            const headers2 = Object.assign({}, this.headers);
            const data = yield (0, fetch_1.post)(this.fetch, `${this.url}/verify`, { phone, token: token2, type: "sms", redirect_to: options.redirectTo }, { headers: headers2 });
            const session = Object.assign({}, data);
            if (session.expires_in)
              session.expires_at = (0, helpers_1.expiresAt)(data.expires_in);
            return { data: session, error: null };
      ...
      verifyOTP({ email, phone, token: token2, type = "sms" }, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            const headers2 = Object.assign({}, this.headers);
            const data = yield (0, fetch_1.post)(this.fetch, `${this.url}/verify`, { email, phone, token: token2, type, redirect_to: options.redirectTo }, { headers: headers2 });
            const session = Object.assign({}, data);
            if (session.expires_in)
              session.expires_at = (0, helpers_1.expiresAt)(data.expires_in);
            return { data: session, error: null };
      ...
      inviteUserByEmail(email, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const data = yield (0, fetch_1.post)(this.fetch, `${this.url}/invite${queryString}`, { email, data: options.data }, { headers: headers2 });
            return { data, error: null };
          } catch (e2) {
            return { data: null, error: e2 };
          }
      ...
      resetPasswordForEmail(email, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const data = yield (0, fetch_1.post)(this.fetch, `${this.url}/recover${queryString}`, { email, gotrue_meta_security: { hcaptcha_token: options.captchaToken } }, { headers: headers2 });
            return { data, error: null };
          } catch (e2) {
            return { data: null, error: e2 };
          }
      ...
      setAuth(token2) {
        ...
        this.channels.forEach((channel) => {
          ...
          if (channel.joinedOnce && channel.isJoined()) {
            channel.push(constants_1.CHANNEL_EVENTS.access_token, { access_token: token2 });
          }
        });
      }
  ...
  "node_modules/@supabase/functions-js/dist/main/index.js"(exports2) {
    ...
    var FunctionsClient = class {
      ...
      invoke(functionName, invokeOptions) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            const { headers: headers2, body } = invokeOptions !== null && invokeOptions !== void 0 ? invokeOptions : {};
...
var import_meta2 = {};
var supabase = (0, import_supabase_js.createClient)(import_meta2.env.VITE_DATABASE_URL, import_meta2.env.VITE_DATABASE_PUBLIC_KEY);
...
// netlify/functions/project-cards.js
var supabase2 = (0, import_supabase_js2.createClient)(process.env.VITE_DATABASE_URL, process.env.VITE_DATABASE_PUBLIC_KEY);
exports.handler = async function(event) {
  ...
  const gitHubIssueNumer = gitHubProjectCard.content_url.split("https: //api.github.com/repos/addisonschultz/github-cards/issues/").pop();
  const headers2 = {
    Accept: "application/vnd.github.v3+json",
    Authorization: `token ${process.env.VITE_GH_ACCESS_TOKEN}`
  };
  const gitHubProjectColumn = await fetch2(`https://api.github.com/projects/columns/${gitHubProjectColumnId}`, {
    method: "GET",
    headers: headers2
  ...
  const { data, error } = await supabase2.from("card-mapping").select("id, miroAppCardId::text, gitHubIssueId, miroUserId::text, gitHubUsername, created_at, miroBoardId, gitHubIssueNumber, auth ( access_token )").eq("gitHubIssueNumber", gitHubIssueNumer);
  if (error) {
    return {
      statusCode: 200,
      body: JSON.stringify({
